            ...
            <div class="card card-2"><!--左边图片 + 整个registration Info的box-->
                ...
                <div class="card-body"><!--整个registration Info的box-->
                    ...
                    <form method="POST" action="./php/action.php">
                        ...
                        <div>
                            <a href="https://147.158.231.137/link/guide/redbrick/index.html">匿名参观（无法参加抽奖）</a>
                            <br>
                            <br>
                        ...
                        <div>
                            <br>
                            <button class="btn btn--radius btn--blue" type="submit" id="button" name="submit2" disabled>确认</button>
                        </div>
                   </form> 
